...
<div class="main_content_iner">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="gps fs-4 mb-0">Job Tickets</h1>
        <div class="d-flex gap-2">
            <div class="search-container">
                <input type="text" class="form-control form-control1 search-input" placeholder="Search..." style="width: 256px;">
            ...
            <a href="#" data-bs-toggle="modal" data-bs-target="#addcategory" class="btn_1">+ Add</a>
