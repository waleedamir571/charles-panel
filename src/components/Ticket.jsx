            ...
            <div className="white_card_header">
              <div className="row align-items-center">
                <div className="col-md-6 col-12 mb-2 mb-md-0">
                  <h1 className="fw-semibold fs-3 mb-0">Job Tickets</h1>
                </div>
                      ...
                      <div className="card-body">
                          ...
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-10">
                              <div className="progress h-30">
                                <div
                                  className="progress-bar bg-lime-400 fs-6 text-black"
                                  role="progressbar"
                                  style={{width: "60%"}}
                                  aria-valuenow="60"
                                  aria-valuemin="0"
                        ...
                        <div className="row text-center">
                          ...
                          <div className="col-4 border-end">
                            ...
                            <div className="icon-container">
                              <img src="/assets/img/home/user-blue.png" alt="" />
                            </div>
                            <p className="fw-bold fs-4 mb-0 job-text">27</p>
                          </div>
                          <div className="col-4">
                        ...
                        <div className="mb-3">
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-10">
                              <div className="progress  h-30">
                                <div
                                  className="progress-bar bg-green-300 fs-6 text-black"
                                  role="progressbar"
                                  style={{ width: "80%" }}
                                  aria-valuenow="80"
                                  aria-valuemin="0"
                        ...
                        <div className="mb-3">
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-10">
                              <div className="progress  h-30">
                                <div
                                  className="progress-bar bg-yellow-400 fs-6 text-black"
                                  role="progressbar"
                                  style={{ width: "30%" }}
                                  aria-valuenow="30"
                                  aria-valuemin="0"
                        ...
                        <div className="mb-3">
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-10">
                              <div className="progress  h-30">
                                <div
                                  className="progress-bar bg-green-500 fs-6 text-black"
                                  role="progressbar"
                                  style={{width: "100%"}}
                                  aria-valuenow="100"
                                  aria-valuemin="0"
