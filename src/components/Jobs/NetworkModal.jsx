...
const NetworkModal = ({ onClose }) => {
  ...
  const handleDoneClick = () => {
    ...
    setTimeout(() => {
      setJobStatus(null); // Reset jobStatus after 1 second to hide the successful message
      onClose();
    }, 2000);
  };
  ...
  return (
    <div className="network-modal-overlay">
      {jobStatus ? (
        ...
        >
          <img
            src={`/images/icons/job-accepted.svg`}
            alt={jobStatus}
            className="mb-3"
            style={{ width: 80 }}
          />
        ...
        <div className="network-modal-content p-4" ref={modalRef}>
          ...
          <div className="d-flex align-items-center justify-content-between gap-2 w-100 mt-3">
            {/* Search box */}
            <div className="position-relative w-100">
              <input
                type="text"
                className="form-control"
                placeholder="(LAX) Airport, Los Angeles,CA"
                style={{
                  height: "50px",
                  zIndex: "1",
                  width: "200px", // Adjust width to control truncation
                  fontSize: "13px",
              ...
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-search search-icon position-absolute top-50 end-0 translate-middle-y me-3 z-3"
                viewBox="0 0 16 16"
                style={{ zIndex: "99999" }}
              >
          ...
          <div className="d-flex justify-content-between flex-wrap align-items-center mb-3">
            <div className="d-flex align-items-center">
              ...
              <h6 className="text-black mb-0 ms-2">All</h6>
            </div>
            ...
            <div className="d-flex gap-3">
              <button
                ...
                onClick={() => setStatusFilter("driver")}
              >
                Driver
              </button>
              <button
                ...
                onClick={() => setStatusFilter("companies")}
              >
                Companies
              </button>
              <button
