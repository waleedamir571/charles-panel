    ...
    <div class="white_card card_height_100 mb_30">
        <div class="white_card_body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="fw-bold fs-4 mb-0">Details    <span class="year">(2007 Peterbilt 389)</span></h1>
                ...
                <div class="d-flex gap-2">
                    ...
                    <p class="asset-unit">Date Entered <span class="year">: 01-21-2025</span></p>
                    <a href="set-reminder.php" class="btn_1"><svg xmlns="http://www.w3.org/2000/svg" width="21"
                            height="21" viewBox="0 0 21 21" fill="none">
                            <g clip-path="url(#clip0_1113_3608)">
                                <path
                            ...
                            <defs>
                                <clipPath id="clip0_1113_3608">
                                    <rect width="20" height="20" fill="white" transform="translate(0.28125 0.810547)" />
                                </clipPath>
                            </defs>
                        </svg>&nbsp;  Maintenance</a>
                    <a href="" class="btn_1">Inspect</a>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class=" job-ticket4">
                            ...
                            <div class="card-body">
                                <div class="row truck-info">
                                    <div class="col-md-2">
                                        <img class="w-100" src="img/home/truck3.png" alt="">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="info-label2">Truck No. :<span class="year">2345332</span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="info-label2">Truck No. :<span class="year">2345332</span>
                                    ...
                                    <div class="col-md-2">
                                        <img src="img/home/view-doc.png" alt="">
                                    </div>
                        ...
                        <div class="row">
                                                ...
                                                <div class=" job-ticket4">
                                                    <div class="  row">
                                                        <div class="col-md-12 text-center">
                                                           ...
                                                           <br>
                                                           <div class="gps">No Outstanding Reports</div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="">
                                    <div class="gps">Inspection History</div>
                                    <div class="ptb-15">
                                    <div class="line-container"></div>
                                </div>
                                                ...
                                                <div class="job-ticket7">
                                                    <div class="  gap-2">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-4 text-center">
                                                                <span class="asset-unit">01-21-2025</span>
                                                            </div>
                                                            <div class="col-md-4 ">
                                                                <div class="report text-end">View Report</div>
                                                            </div>
                                                        </div>
                                                    </div>
